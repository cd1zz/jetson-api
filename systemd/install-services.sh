...
echo "  sudo systemctl enable llama-deepseek llama-qwen llama-minicpm-v llama-qwen2.5-vl llama-qwen3-embedding jetson-api"
echo "  sudo systemctl start llama-deepseek llama-qwen llama-minicpm-v llama-qwen2.5-vl llama-qwen3-embedding jetson-api"
echo ""
echo "To enable only text models + embeddings + API (recommended for testing):"
echo "  sudo systemctl enable llama-deepseek llama-qwen llama-qwen3-embedding jetson-api"
echo "  sudo systemctl start llama-deepseek llama-qwen llama-qwen3-embedding jetson-api"
echo ""
