...
echo "  sudo systemctl enable llama-qwen llama-qwen-coder llama-qwen3-vl llama-qwen3-embedding jetson-api"
echo "  sudo systemctl start llama-qwen llama-qwen-coder llama-qwen3-vl llama-qwen3-embedding jetson-api"
echo ""
echo "To check status:"
echo "  sudo systemctl status jetson-api"
echo "  sudo systemctl status llama-qwen"
echo "  sudo systemctl status llama-qwen-coder"
echo "  sudo systemctl status llama-qwen3-vl"
echo "  sudo systemctl status llama-qwen3-embedding"
echo ""
echo "To view logs:"
echo "  sudo journalctl -u jetson-api -f"
echo "  sudo journalctl -u llama-qwen-coder -f"
